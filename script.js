const semestres = {
  ...
  "2° Semestre": [
    ...
    { id: "fisiologia_gral", nombre: "Fisiología general", prereq: ["fisica", "quimica"] },
    { id: "neuroanato", nombre: "Neuroanatomía" }
  ],
    "3° Semestre": [
    { id: "fisiologia_sistemas", nombre: "Fisiología de sistemas", prereq: ["neuroanato", "fisiologia_gral"] },
    { id: "infectologia", nombre: "Bases Integradas de Infectología, Inmunología y Farmacología General", prereq: ["neuroanato", "fisiologia_gral"] },
    { id: "examen_kinesico", nombre: "Examen Kinésico Básico", prereq: ["anatomia1", "biomecanica"] },
  ...
  "4° Semestre": [
    { id: "fisiopato", nombre: "Fisiopatología y Farmacología de Sistemas", prereq: ["fisiologia_sistemas", "infectologia"] },
    { id: "examen_cond_fisica", nombre: "Examen de la Condición Física y la Conducta Motora", prereq: ["examen_kinesico"] },
    { id: "proc_terapeuticos", nombre: "Procedimientos Terapéuticos Básicos y Generales", prereq: ["examen_kinesico", "movimiento_humano"] },
    ...
    "5° Semestre": [
    { id: "actividad_salud", nombre: "Efectos de Actividad Física en la Salud", prereq: ["fisiopato", "examen_cond_fisica"] },
    { id: "neurokine1", nombre: "Evaluación e Intervención en Neurokinesiología I", prereq: ["desarrollo_psicomotor"] },
    { id: "respiratorio1", nombre: "Evaluación e Intervención en Cuidados Respiratorios I", prereq: ["fisiopato", "examen_cond_fisica"] },
    ...
    { id: "modulo_i", nombre: "Módulo Integrado Interdisciplinario y Multiprofesional I" } // 90 créditos, pero asumimos que está disponible al llegar a este punto
  ],
  "6° Semestre": [
    ...
    { id: "actividad_deporte", nombre: "Actividad Física y Deportes", prereq: ["actividad_salud", "educ_fisica1"] }
  ],
    "7° Semestre": [
